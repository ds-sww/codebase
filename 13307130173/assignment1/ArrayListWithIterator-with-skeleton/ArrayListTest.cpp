...
void rand_insert_delete_entrys(List<int>& list, double insertFactor) {
    cout << "rand_insert_delete_entrys start   insertFactor : " << insertFactor <<  endl;
    ...
    cout << "rand_insert_delete_entrys end." << endl;
}
...
int main() {
    ...
    for (int i = 0; i< 10; ++i) {
        ArrayList<int> list3;
        rand_insert_delete_entrys(list3, i);
    }
